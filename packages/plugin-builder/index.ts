...
const STATIC_JAR = resolve(
  import.meta.dir,
  "../../fixtures/rules/static-rule.jar"
);
const STATIC_JSON = resolve(
  import.meta.dir,
  "../../fixtures/rules/static-rule.json"
);
...
export async function buildRuleJar(
  ...
  return {
    jarUrl: existsSync(STATIC_JAR)
      ? `file://${STATIC_JAR}`
      : "fixture://static-rule.json",
    contentDigest,
  };
}
